...
begin
  ...
  PInst^.Branch.Flags := bfUsed or bfRel;
...
begin
  ...
  PInst^.Branch.Flags := bfUsed or bfIndirect or bfAbs;
  if Assigned(PInst^.VirtualAddr) then
  ...
  begin
    ...
    begin
      ...
      PInst^.Branch.Flags := PInst^.Branch.Flags or bfRip;
  ...
  begin
    ...
    PInst^.Branch.Flags := PInst^.Branch.Flags or bfReg;
...
begin
  SetOpCode(PInst);
  PInst^.Branch.Flags := bfUsed or bfFar;
